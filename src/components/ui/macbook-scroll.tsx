...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="  flex min-h-[200vh] flex-shrink-0 scale-[0.7] transform flex-col items-center justify-start py-0 sm:min-h-[200vh] sm:[perspective:50px] md:min-h-[200vh] md:scale-100 md:py-80  md:[perspective:500px] lg:[perspective:1000px]"
    >
      <motion.h2
        style={{
